  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        ...
        <h1 className="text-2xl font-bold mr-96">Technical Skills</h1>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 py-6 md:grid-cols-2 lg:gap-8">
        ...
        <div>
          <p className="text-justify mb-4">
            Hey, I’m <span className="font-semibold text-blue-400">Omar Essam El Din</span> — a
            frontend developer passionate about crafting sleek, responsive, and modern UIs. I
            specialize in building interactive web experiences that blend design with performance.
          </p>
          <p className="text-justify mb-4">
            With a strong background in <span className="font-medium">JavaScript, TypeScript, and modern frameworks</span>, 
            I thrive on turning ideas into clean, functional, and visually engaging applications. 
            My focus is always on delivering smooth user experiences and writing scalable, maintainable code.
          </p>
          ...
          <a 
            href="/files/OmarEssam-CV.pdf" 
            download="OmarEssam-CV.pdf"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {skillCategories.map((category, idx) => (
            <div
              key={idx}
              className="rounded-2xl  backdrop-blur-lg p-6 shadow-lg border border-gray-700"
            >
              <div className="flex items-center gap-2 mb-4">
                <span className="bg-blue-600/20 p-2 rounded-lg">{category.icon}</span>
              ...
              <div className="flex flex-wrap gap-3">
                {category.skills.map((skill, i) => (
                  <span
                    key={i}
                    className="px-3 py-1 text-sm rounded-lg bg-cyan-900/40 text-cyan-300 border border-cyan-700 hover:bg-cyan-700 hover:text-white transition"
                  >
                    {skill}
                  </span>
                ))}
